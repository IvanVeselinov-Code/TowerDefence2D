if(imagealpha = true)
			{
				oHealthBar.image_alpha = 0.1;
				oHealthBarFrame.image_alpha = 0.1;
				oBiggerRock.image_alpha = 0.5;
				oRock.image_alpha = 0.5;
				oRock1.image_alpha = 0.5;
			...
			{
				oHealthBar.image_alpha = 1;
				oHealthBarFrame.image_alpha = 1;
				oBiggerRock.image_alpha = 1;
				oRock.image_alpha = 1;
				oRock1.image_alpha = 1;
